...
router.post('/northernireland/iteration1/answer-some-questions', function(req, res) {
...
router.post('/northernireland/iteration1/answer-some-questions-q1', function(req, res) {
...
router.post('/northernireland/iteration1/answer-some-questions-q2', function(req, res) {
...
router.post('/northernireland/iteration1/answer-some-questions-q3', function(req, res) {
...
// where-do-you-live
router.post('/northernireland/iteration1/where-do-you-live', function(req, res) {
...
router.post('/northernireland/iteration1/outside-uk', function(req, res) {
...
router.post('/northernireland/iteration1/where-does-the-other-parent-live', function(req, res) {
...
router.post('/northernireland/iteration1/other-parent-outside-uk', function(req, res) {
...
router.post('/northernireland/iteration1/will-you-be-paying-or-receiving', function(req, res) {
...
router.post('/northernireland/iteration1/have-you-had-a-court-decision', function(req, res) {
...
router.post('/northernireland/iteration1/what-do-you-want-to-do', function(req, res) {
...
// domestic-abuse-help
router.post('/northernireland/iteration1/domestic-abuse-help', function(req, res) {
  if (req.body['da-yes'] === 'tell-someone') {
    res.redirect('what-do-you-want-to-do');
  } else if (req.body['da-no'] === 'what-do-you-want-to-do'){
    res.redirect('tell-someone');
  }
...
router.post('/northernireland/iteration1/get-more-information', function(req, res) {
...
router.post('/northernireland/iteration1/how-do-you-want-to-apply', function(req, res) {
...
router.post('/northernireland/iteration1/your-application-reference-number', function(req, res) {
...
router.post('/northernireland/iteration1/your-application-reference-number-online', function(req, res) {
  if (req.body['send-reference'] === 'yes') {
...
router.post('/northernireland/iteration1/email-or-text-message', function(req, res) {
...
// email-sent-by-phone
router.post('/northernireland/iteration1/emailSentAnswer', function(req, res) {
...
router.post('/northernireland/iteration1/textMessageSent', function(req, res) {
  const contact = req.session.data['contact-method']
    if (contact === 'phone') {
    res.redirect('answer-some-questions.html');
  } else {
...
router.post('/northernireland/iteration1/confirm-email', function(req, res) {
...
router.post('/northernireland/iteration1/confirm-email-online', function(req, res) {
  if (req.body['confirm-email'] === 'yes') {
...
router.post('/northernireland/iteration1/confirm-mobile-number', function(req, res) {
...
router.post('/northernireland/iteration1/confirm-mobile-number-online', function(req, res) {
  if (req.body['confirm-mobile-number'] === 'yes') {
...
router.post('/northernireland/iteration1/text-message-sent-online', function(req, res) {
  if (req.body['will-you-be-paying-or-receiving'] === 'paying'){
    res.redirect('apply-by-phone');
  } else {
    res.redirect('start-your-application');
...
router.post('/northernireland/iteration1/writeDownYourReference', function(req, res) {
  const contact = req.session.data['contact-method']
    if (contact === 'phone') {
    res.redirect('answer-some-questions.html');
  } else {
...
router.post('/northernireland/iteration1/start-your-application', function(req, res) {
